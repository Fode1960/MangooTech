-- Supprimer la politique temporaire et créer des politiques propres

-- Supprimer la politique temporaire
DROP POLICY IF EXISTS "Test permissive update policy" ON public.shops;

-- Supprimer les politiques existantes pour les remplacer
...
-- Politique pour permettre aux propriétaires de voir leurs propres boutiques
