...
const server = http.createServer((req, res) => {
    ...
    // Supprimer les paramètres d'URL (query string)
    ...
    // Gestion spécifique des fichiers dans /public
    // Si le fichier n'est pas trouvé à la racine, on cherche dans /public
    if (!fs.existsSync(filePath) && fs.existsSync('./public' + req.url.split('?')[0])) {
