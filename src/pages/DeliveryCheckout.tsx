      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-[#eef6ea] border border-[#d7e4d1] shadow-sm flex items-center justify-center">
        ...
        <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-xl">
          {error && <div className="px-4 py-3 rounded-2xl bg-red-50 border border-red-200 text-red-800 text-sm">{error}</div>}

          {sourceOrderId && (
            <div className="mt-4 px-4 py-3 rounded-2xl bg-[#eef6ea] border border-[#cfe0c8] text-[#1b5e20] text-sm font-black">
              Livraison pour la commande: {sourceOrderId}
            </div>
          )}

          {deliveryQuote && (
            <div className="mt-4 px-4 py-3 rounded-2xl bg-[#eef6ea] border border-[#cfe0c8] text-sm">
              <div className="flex items-center justify-between gap-3">
                <div className="font-black">Frais livraison</div>
                <div className="font-black text-[#1b5e20]">{deliveryQuote.feeFcfa.toLocaleString('fr-FR')} FCFA</div>
              </div>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <button
              type="button"
              onClick={submit}
              className="px-4 py-2 rounded-xl bg-[#1b5e20] text-white font-black hover:bg-[#16381a] disabled:opacity-60 disabled:cursor-not-allowed"
