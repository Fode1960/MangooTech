      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 space-x-4">
          <button
            ...
            className="bg-[#1b5e20] hover:bg-[#16381a] text-white font-bold py-3 px-8 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center gap-2 mx-auto mb-4"
          >
          ...
          <button
            ...
            className="bg-[#16381a] hover:bg-[#0d2f13] text-white font-bold py-3 px-8 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center gap-2 mx-auto"
          >
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          {activeRooms.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button
                onClick={handleQuickTest}
                className="mt-4 bg-[#1b5e20] hover:bg-[#16381a] text-white font-bold py-2 px-6 rounded-lg transition-colors"
              >
