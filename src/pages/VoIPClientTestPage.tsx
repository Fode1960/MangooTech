...
const VoIPClientTestPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">🎧 Test VoIP - Client SIP</h1>
          <p className="text-gray-300 mb-6">
            Testez les appels VoIP avec votre serveur SIP (compte 8889)
          </p>
          <div className="flex justify-center space-x-4">
            ...
            >
              Ouvrir Vendeur VoIP (8888) →
            </Link>
            <Link 
              to="/live-shopping-client-test" 
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-700 p-4 rounded-lg">
                ...
                <p className="text-green-400 font-mono">8889</p>
                <p className="text-sm text-gray-400 mt-1">Serveur: localhost:5060</p>
              </div>
              <div className="bg-gray-700 p-4 rounded-lg">
                <h3 className="text-lg font-medium mb-2">Mode</h3>
                <p className="text-blue-400">Client / Acheteur</p>
                <p className="text-sm text-gray-400 mt-1">Reçoit les appels du vendeur (8888)</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-900 bg-opacity-20 border border-yellow-700 rounded-lg p-4 mt-6">
            ...
            <ol className="text-yellow-200 text-sm space-y-1">
              <li>1. Ouvrez le vendeur VoIP (8888) dans un autre onglet</li>
              <li>2. Assurez-vous que les deux comptes SIP sont connectés</li>
              <li>3. Attendez l'appel du vendeur 8888</li>
              <li>4. Répondez à l'appel entrant</li>
...
export default VoIPClientTestPage;