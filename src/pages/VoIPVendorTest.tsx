...
const VoIPVendorTest = () => {
  ...
  const udpSocketRef = useRef<any>(null);
    ...
    try {
      ...
      ws.onmessage = async (event) => {
        ...
        switch (message.type) {
          ...
          case 'registered':
            setStatus('Enregistré comme vendeur');
            await setupAudio();
            break;

          case 'incoming-call':
            setCallStatus('Appel entrant du client...');
          ...
          case 'call-answered':
            setIsInCall(true);
            setIsCalling(false);
            setCallStatus('Appel en cours avec le client');
            currentCallId.current = message.callId;
            console.log('📞 Appel établi avec le client');
            break;

          case 'call-connected':
            setIsInCall(true);
            setIsCalling(false);
            setCallStatus('Appel connecté avec le client');
            currentCallId.current = message.callId;
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-2xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Test VoIP - Vendeur</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            >
              ...
              <span className="text-sm">Appeler Client</span>
            </button>
          ...
          <div className="mt-8 bg-gray-50 rounded-lg p-6">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              <li>1. Ouvrez le lien client dans un autre navigateur</li>
              <li>2. Cliquez sur "Appeler Client" pour lancer un appel</li>
              <li>3. Parlez dans votre microphone pour tester l'audio</li>
              <li>4. Écoutez la qualité du son côté client</li>
