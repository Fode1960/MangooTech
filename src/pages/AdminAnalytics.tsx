      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 bg-[#eef6ea] dark:bg-[#17331c] rounded-lg flex items-center justify-center">
              <span className="text-[#1b5e20] dark:text-[#66bb6a] text-xl">👥</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 bg-[#ffe082]/30 dark:bg-[#8f4b00]/30 rounded-lg flex items-center justify-center">
              <span className="text-[#8f4b00] dark:text-[#ffe082] text-xl">📦</span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-[#8f4b00] rounded-full"></div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div className="bg-[#1b5e20] h-2 rounded-full" style={{ width: '32%' }}></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between items-center mb-2">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div className="bg-[#1b5e20] h-2 rounded-full" style={{ width: '94%' }}></div>
              </div>
            </div>
          </div>
        </div>
