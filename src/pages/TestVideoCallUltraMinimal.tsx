// Version ultra-minimale sans icônes pour éviter les erreurs React DOM
import React, { useState, useRef, useEffect } from 'react';

export default function TestVideoCallUltraMinimal() {
  ...
  // Utiliser useLayoutEffect pour éviter les erreurs DOM
  useEffect(() => {
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '20px', textAlign: 'center' }}>
          Test Appel Vidéo Ultra Minimal
        </h1>
