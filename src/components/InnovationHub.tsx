...
export default function InnovationHub() {
  ...
  const renderActiveComponent = () => {
    switch (activeInnovation) {
      ...
      case 'blockchain':
        return (
          <div className="bg-[#f6faf3] p-8 rounded-xl">
            <div className="text-center">
              <Blocks className="w-20 h-20 text-[#1b5e20] mx-auto mb-4" />
      ...
      case 'voice-synthesis':
        return (
          <div className="bg-[#f6faf3] p-8 rounded-xl">
            <div className="text-center">
              <Volume2 className="w-20 h-20 text-[#1b5e20] mx-auto mb-4" />
      ...
      case 'microservices':
        return (
          <div className="bg-[#f6faf3] p-8 rounded-xl">
            <div className="text-center">
              <Server className="w-20 h-20 text-[#1b5e20] mx-auto mb-4" />
              ...
              <button
                ...
                className={`p-6 rounded-xl border-2 transition-all duration-300 transform hover:scale-105 ${
                  activeInnovation === innovation.id
                    ? 'border-[#1b5e20] bg-white shadow-xl'
                    : 'border-gray-200 bg-white hover:border-gray-300 hover:shadow-lg'
                }`}
              >
                <div className="w-16 h-16 rounded-full bg-[#1b5e20] flex items-center justify-center mx-auto mb-4">
        ...
        <div className="text-center mt-12">
          <div className="bg-[#1b5e20] rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="px-8 py-3 bg-white text-[#1b5e20] rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Tester Maintenant
              </button>
              <button className="px-8 py-3 bg-[#16381a] text-white rounded-lg font-semibold hover:bg-[#0d2f13] transition-colors">
