          ...
          <div className="max-w-md">
            ...
            <form className="flex space-x-3">
              <input
                ...
                className="flex-1 px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-900 placeholder-gray-500"
              />
              <button
                type="submit"
