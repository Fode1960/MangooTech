...
export const LazyPages = {
  ...
  Terms: createLazyComponent(() => import('../pages/Terms')),
  Privacy: createLazyComponent(() => import('../pages/Privacy')),
  Cookies: createLazyComponent(() => import('../pages/Cookies')),
  ...
  // EmailConfirmation: createLazyComponent(() => import('../pages/EmailConfirmation')), // Supprimée - confirmation d'email désactivée
