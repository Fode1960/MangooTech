-- Migration pour créer les tables du système d'administration
-- Tables : shops, shop_categories, commission_rules, admin_users, shop_analytics, user_roles
...
-- Table des boutiques/shops (extension de la table existante)
-- Cette migration ajoute des colonnes à la table shops existante
ALTER TABLE shops 
