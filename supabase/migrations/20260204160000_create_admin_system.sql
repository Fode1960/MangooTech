...
-- Tables : user_roles, shop_categories, commission_rules, admin_users, shop_analytics, admin_activity_logs, system_settings
...
-- Extension de la table shops existante
ALTER TABLE shops 
